...
export default function CandidateProfile() {
    ...
    const handleToggle = () => {
        setForm({...form, isEdit: !form.isEdit })// everything is disabled when we click on edit we can edit like prefilled characters in flipkart.
    }
        ...
        <div>
            ...
            <label htmlFor="firstName">FirstName</label><br />
                <input 
                    ...
                    name="firstName" 
                    id="firstName"
                    disabled={!form.isEdit}// by default that input field is disabled.
                /> <br />
