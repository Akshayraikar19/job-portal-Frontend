    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                { formData.clientErrors.openings && <span style={{ color: 'red'}}>{ formData.clientErrors.openings} </span>}<br />

                <label htmlFor="location">Location</label><br />
                <input type="text" id="location" value={formData.location} name="location" onChange={handleChange} />
                { formData.clientErrors.location && <span style={{ color: 'red'}}>{ formData.clientErrors.location} </span>}<br />
                ...
                <label htmlFor="minExp">Min Experience</label><br />
                 ...
                 { formData.clientErrors.minExp && <span style={{ color: 'red'}}>{ formData.clientErrors.minExp} </span>}<br /><br />
                ...
                <label htmlFor="maxExp">Max Experience</label><br />
                 ...
                 { formData.clientErrors.maxExp && <span style={{ color: 'red'}}>{ formData.clientErrors.maxExp} </span>}<br /><br />

                <label htmlFor="skills">Skills</label><br />
                <input type="text" id="skills" value={formData.skills} name="skills" onChange={handleChange} />
                { formData.clientErrors.skills&& <span style={{ color: 'red'}}>{ formData.clientErrors.skills} </span>}<br /><br />
                ...
                { formData.clientErrors.dueDate && <span style={{ color: 'red'}}>{ formData.clientErrors.dueDate} </span>}<br /><br />
              ...
              { formData.clientErrors.minSalary && <span style={{ color: 'red'}}>{ formData.clientErrors.minSalary} </span>}<br /><br />
             ...
             { formData.clientErrors.maxSalary && <span style={{ color: 'red'}}>{ formData.clientErrors.maxSalary} </span>}<br /><br />
